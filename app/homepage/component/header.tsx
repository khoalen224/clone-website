...
export default function HeaderExport(){
    ...
    return(
        <div className="w-full">
            ...
            >
                <div className=" mt-7 mb-3 max-w-8xl mx-auto items-center flex ml-15 " >
                    <Link
                        href="/homepage"
                    >
                        <img
                    ...
                    <div className={`ml-2 px-4 py-2`}>
                        {!user ? (
                            ...
                            <div className="flex items-center gap-2 mr-5">
                                ...
                                <span className={isScrolled || isHovered ? 'text-gray-700 font-medium' : 'text-white font-medium'}>
                                    {user.name}
                                </span>
                                <ChevronDown 
                                    className={`w-4 h-4 transition-transform ${showDropDown ? 'rotate-180' : ''} ${
                                    isScrolled || isHovered ? 'text-gray-700' : 'text-white'
                                    }`} 
                                />
                            </div>
                            {showDropDown && (
                              <div 
                                className="absolute right-0 top-full w-56 bg-white rounded-lg shadow-lg py-1 z-50 border border-gray-200"
                              >
                                <button
                    ...
                    <Link
                        className="h-8 w-22 bg-blue-500 rounded text-white flex items-center justify-center " 
                        href="/shopping"
                    >
                        <svg
                            width="24"
